...
snv_min_af = 0.05
normal_snv_max_af = 0.5
normal_snv_max_af_dict = {'ont': 0.2, 'ilmn': 0.05, 'hifi': 0.2}
# normal_snv_max_af_dict = {'ont': 0.2, 'ilmn': 0.2, 'hifi': 0.2}
...
min_thred_qual = {'ont': 4, 'ont_r10': 4, 'ont_r9': 4, 'ont_r10_dorado_sup_5khz': 4, 'ont_r10_dorado_hac_5khz': 4,'ont_r10_dorado_hac_4khz': 4, 'ont_r10_dorado_sup_4khz': 4, 'ilmn': 2, 'hifi': 4, 'hifi_sequel2': 4, 'hifi_revio': 4}
best_thred_qual = {'ont': 8, 'ont_r10': 8, 'ont_r9': 8, 'ilmn': 4, 'hifi': 8, 'hifi_sequel2': 8, 'hifi_revio': 8}
...
af_dict = {'ont': None, 'ilmn': None, 'hifi': None}
af_dict_min = {'ont': 0.05, 'ilmn': 0.05, 'hifi': 0.05}
af_dict_max = {'ont': 0.5, 'ilmn': 0.5, 'hifi': 0.5}
...
upper_beta = 1
lower_beta = 1
upper_beta_dict = {'ont': 3, 'ilmn': 6, 'hifi': 3}
lower_beta_dict = {'ont': 2, 'ilmn': 4, 'hifi': 2}
# upper_beta_dict = {'ont': 3, 'ilmn': 3, 'hifi': 3}
# lower_beta_dict = {'ont': 2, 'ilmn': 2, 'hifi': 2}
upper_beta_liqud = 5
