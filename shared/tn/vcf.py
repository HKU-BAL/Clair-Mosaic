...
from shared.tn.utils import subprocess_popen, Position as Position, file_path_from
import shared.tn.param as param
...
vcf_header = dedent("""\
            ...
            ##FILTER=<ID=NonMosaic,Description="Non-mosaic variant tagged by panels of normals">
            ##INFO=<ID=FAU,Number=1,Type=Integer,Description="Count of A in forward strand in the input BAM">
            ##INFO=<ID=FCU,Number=1,Type=Integer,Description="Count of C in forward strand in the input BAM">
            ##INFO=<ID=FGU,Number=1,Type=Integer,Description="Count of G in forward strand in the input BAM">
            ##INFO=<ID=FTU,Number=1,Type=Integer,Description="Count of T in forward strand in the input BAM">
            ##INFO=<ID=RAU,Number=1,Type=Integer,Description="Count of A in reverse strand in the input BAM">
            ...
            ##FORMAT=<ID=DP,Number=1,Type=Integer,Description="Read depth in the input BAM">
            ##FORMAT=<ID=AF,Number=1,Type=Float,Description="Estimated allele frequency in the input BAM">
            ##FORMAT=<ID=AD,Number=R,Type=Integer,Description="Allelic depths for the ref and alt alleles in the order listed in the input BAM">
            ##FORMAT=<ID=NAF,Number=1,Type=Float,Description="Estimated allele frequency in the control BAM">
            ##FORMAT=<ID=NDP,Number=1,Type=Integer,Description="Read depth in the control BAM">
            ##FORMAT=<ID=NAD,Number=R,Type=Integer,Description="Allelic depths for the ref and alt alleles in the order listed in the control BAM">
            ##FORMAT=<ID=AU,Number=1,Type=Integer,Description="Count of A in the input BAM">
            ##FORMAT=<ID=CU,Number=1,Type=Integer,Description="Count of C in the input BAM">
            ##FORMAT=<ID=GU,Number=1,Type=Integer,Description="Count of G in the input BAM">
            ##FORMAT=<ID=TU,Number=1,Type=Integer,Description="Count of T in the input BAM">
            ##FORMAT=<ID=NAU,Number=1,Type=Integer,Description="Count of A in the control BAM">
            ##FORMAT=<ID=NCU,Number=1,Type=Integer,Description="Count of C in the control BAM">
            ##FORMAT=<ID=NGU,Number=1,Type=Integer,Description="Count of G in the control BAM">
            ##FORMAT=<ID=NTU,Number=1,Type=Integer,Description="Count of T in the control BAM">
